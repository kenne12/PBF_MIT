 ...
 */
@Entity
@Table(name = "completude_data_style")
public class CompletudeDataStyle implements Serializable {
    ...
    public CompletudeDataStyle() {
    }

    public CompletudeDataStyle(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final CompletudeDataStyle other = (CompletudeDataStyle) obj;
